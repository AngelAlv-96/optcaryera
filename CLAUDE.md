...
**Última versión**: v293 — Dos cambios al prompt de Clari (wa-webhook.js + meta-webhook.js). (1) Promo Hot Sale Aplazo (25 may - 2 jun 2026, 25% off clientes nuevos + 3 quincenas s/i desde $2,000, código HS2026) agregada a `getActivePromos()` con guard de fechas auto-expirante. Clari la menciona solo si preguntan por Aplazo/financiamiento, aclarando que el descuento es directo de Aplazo (NO de la óptica). (2) Reglas anti-coqueteo en DEFAULT_PERSONALITY de ambos webhooks (Clari WhatsApp + Messenger + IG): ante cumplido personal a Clari / ofrecimiento de número / selfie no óptica / apodos cariñosos → modo neutral (0 emojis, sin reciprocar cumplidos, 1 línea seca + redirección). NO confunde con cortesía mexicana (gracias ❤️/😘/🥰 como agradecimiento genérico NO es trigger). Disparado por caso Meño (phone 5216751038234, Messenger): Clari aclaró rol pero su tono cálido reciprocó el coqueteo durante toda la conversación. Anterior v292: Sistema "📩 Mi sobre" completo end-to-end (cobro de comisiones quincenales por empleado, PIN self-setup, gating por tareas pendientes, cobro caja/transferencia, panel auditoría con deshacer).
