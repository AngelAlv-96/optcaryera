...
- Clari reconoce contexto: detecta `[Magnolia-Reactivation]` en historial e inyecta promo 3x1 + ubicación en system prompt
- Review prioridad: review-cron.js pone clientes Magnolia al frente de la cola
- **Landing pages sugeridas**: `/l/magnolia-promo`, `/l/magnolia-lentes`, `/l/magnolia-examen` (crear en módulo Landing Pages)
- **Milestones**: Fase 1 $160K (estabilizar), Fase 2 $200K (parcial), Fase 3 $260K (recuperación total)
- **Promo principal**: 3x1 en Lentes Completos + Examen gratis + Listos en 35 min
...
14. **Rescate Magnolia**: ⬜ Angel pasa reporte SICAR clientes Magnolia (CSV) → adaptar magnolia-reactivate.js para leer de lista estática en vez de tabla ventas, ✅ `MAGNOLIA_TEMPLATE_SID=HX06ad99f2b5c7b1ff5ff3bcc758052c5c` template aprobado por WhatsApp (2026-03-25), ❌ landing pages descartadas (Clari ya trackea conversiones end-to-end por WA, pixel no justificado para volumen local), ✅ Meta Ads geo-targeting zona Magnolia — campaña configurada (pin Plaza Magnolia radio 5km, 18-55, reel + fotos, 4 textos A/B, enviada a revisión), ⬜ limpiar ~322 campañas viejas desactivadas en Ads Manager (UI Meta no permite borrado masivo fácil, intentar desde Business Suite o API)
