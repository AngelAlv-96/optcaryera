...
function getActivePromos() {
  ...
  if (year === 2026 && (month === 4 || month === 5 || month === 6 || month === 7)) {
    return cuponMexico + cuponSolar3x1 + hotSaleCarEra + campanaFotoColor + 'PROMOCIÓN VIGENTE:\n' +
      ...
      '• ⛔ CONFUSIÓN MÁS COMÚN — el cliente cree que PAGA LOS DOS pares (ej. "¿serían dos de $1,200?", "entonces pago dos armazones", "dos de 1200 más graduación", "¿los dos me cuestan el doble?"): DESHAZLA SIEMPRE, es el corazón del 2x1. En el 2x1 pagas UN SOLO par completo y el SEGUNDO par va INCLUIDO (NO lo pagas). La graduación de visión sencilla + el antirreflejante ya van DENTRO del precio de ese par (no se pagan aparte). Explícalo claro y con entusiasmo: "Con el 2x1 NO pagas los dos — pagas UN par completo y el segundo va incluido 👓. La graduación sencilla y el antirreflejante ya van en el precio de ese par. El precio del par depende del armazón y material que elijas, en sucursal te dan la cotización exacta." ⛔ NO confirmes ni repitas el número que mencione el cliente ($1,200 u otro) como si fuera el precio final del par — solo explica la mecánica (pagas uno, te llevas dos) y remite la cotización exacta a sucursal.\n' +
