...
function getActivePromos() {
  ...
  // Combo headline (2x1 + solar $499 + armazón+micas+AR+UV): Hot Sale 25 may–2 jun, EXTENDIDO junio, julio y AGOSTO 2026 (presentación "de verano" desde julio).
  var comboActive = now >= new Date('2026-05-25T00:00:00-06:00') && now <= new Date('2026-08-31T23:59:59-06:00');
  var esEventoHotSale = comboActive && now <= new Date('2026-06-02T23:59:59-06:00'); // dentro de los 9 días del Hot Sale nombrado
  var esJulio = comboActive && now >= new Date('2026-07-01T00:00:00-06:00'); // julio en adelante = misma promo, presentación NUEVA (verano), sin "junio" ni "Hot Sale"
  // AGOSTO: la promo CONTINÚA (decisión de Angel 3-ago). Ojo: hubo publicidad que decía "último día lunes 3 de agosto" → Clari debe decir que sigue vigente.
  var esAgosto = comboActive && now >= new Date('2026-08-01T00:00:00-06:00');
  ...
  var comboVigencia = esEventoHotSale ? 'del 25 de mayo al 2 de junio de 2026 (9 días, terminando en martes 2 jun)' : esAgosto ? 'durante agosto de 2026 (sigue vigente este mes)' : esJulio ? 'durante el verano (vigente en julio de 2026)' : 'durante todo junio de 2026 (hasta el 30 de junio)';
  var hotSaleCarEra = comboActive ? (comboHeader +
    ...
    (esAgosto ? '• 📣 LA PROMOCIÓN SIGUE EN AGOSTO: si preguntan hasta cuándo dura, si todavía alcanzan, si ya se acabó, o dicen que el anuncio decía que el ÚLTIMO DÍA era el lunes 3 de agosto → responde con SEGURIDAD que la promoción SIGUE VIGENTE este mes de agosto. ⛔ NUNCA digas que ya terminó ni des una fecha de corte exacta; di simplemente que sigue vigente e invítalo a pasar.\n' : '') +
  ...
  var cuponMexico = (now <= new Date('2026-07-05T23:59:59-06:00')) ?
    '🎟️⚽ CUPÓN MÉXICO (cupón con código personal enviado por WhatsApp, vigente hasta el DOMINGO 5 DE JULIO de 2026 — ÚLTIMO DÍA):\n' +
    ...
    '• Si el cliente pregunta si su cupón SIGUE VÁLIDO: sí, todavía se puede usar, pero mañana DOMINGO 5 DE JULIO es el ÚLTIMO DÍA — invítalo a aprovecharlo hoy o mañana en sucursal.\n' +
  ...
  // Abril 15 en adelante 2026 (combo extendido durante junio, julio Y agosto; desde julio como "promoción de verano").
  if (year === 2026 && (month === 4 || month === 5 || month === 6 || month === 7 || month === 8)) {
    return REGLAS_ALCANCE + String.fromCharCode(10,10) + descEstudiante + cuponVittoria30 + cuponMexico + cuponSolar3x1 + hotSaleCarEra + campanaFotoColor + 'PROMOCIÓN VIGENTE:\n' +
      ...
      '• ⚠️ MARCAS DE DISEÑADOR: el 2x1 funciona con distintas marcas de armazón, PERO NO es "todas las marcas por igual". En marcas de DISEÑADOR/premium (ej. Ray-Ban, Oakley, Vogue, Carolina Herrera, etc.) el límite es: en un 2x1 puedes llevar UNO de marca de diseñador, pero NO los DOS de diseñador. El par válido es: 2 de línea regular, o 1 de diseñador + 1 de línea regular — NUNCA 2 de diseñador. ⛔ NUNCA digas "el 2x1 aplica para todas las marcas sin importar cuál". Ejemplo si preguntan por Ray-Ban: "Sí, puedes incluir un armazón de diseñador como Ray-Ban en tu 2x1, pero solo uno de los dos puede ser de diseñador; el otro sería de nuestra línea. La disponibilidad del modelo la confirmas en sucursal."\n' +
      ...
      '• ⚠️ PROGRESIVOS Y BIFOCALES EN LA PROMO: los progresivos/bifocales SÍ entran, PERO solo UNO de los 2 pares puede ser progresivo O bifocal — el segundo par va de VISIÓN SENCILLA (para cerca O para lejos, el cliente elige). Y el 3er lente solar SIEMPRE es de visión sencilla. ⛔ NUNCA digas ni des a entender que se lleva "2 progresivos" o "3 lentes progresivos". Ejemplo si preguntan por vista cansada/progresivos: "¡Sí entran en la promo! Uno de los 2 pares puede ser progresivo; el segundo va de visión sencilla (para cerca o para lejos, como lo necesites) y el tercer lente solar graduado es de visión sencilla."\n\n' +
      ...
      '☀️ TE LLEVAS 3 LENTES (menciónalo SIEMPRE al explicar la promo — es el gancho principal): además de los 2 lentes del 2x1, el cliente se lleva un TERCER lente solar graduado. En total son 3 LENTES (2 del 2x1 + 1 solar graduado). Ese 3er lente solar VA GRATIS si la compra TOTAL es de $3,000 o más; si la compra es menor a $3,000, cuesta solo $499. El solar es un par adicional (armazón solar + graduación sencilla CR-39). Explícalo así: "Con el 2x1 te llevas 2 lentes + un tercer lente solar graduado = 3 lentes en total; y si tu compra llega a $3,000, ese solar va GRATIS (si es menos, solo $499)." Úsalo para subir el ticket: si el cliente está cerca de $3,000, dile que llegando a esa compra el solar le sale gratis.\n' +
      ...
      '⚠️ NOTA SOBRE LA PUBLICIDAD: Algunos anuncios dicen fechas anteriores ("hasta el 30 de abril", "hasta el 31 de mayo", "Hot Sale hasta el 2 de junio", "hasta el 30 de junio", "último día lunes 3 de agosto") porque la promoción se ha extendido varias veces. Si el cliente pregunta "¿pero el anuncio decía X, ya se acabó?" → responde con SEGURIDAD: "La promoción sigue vigente. ¿Te interesa pasar a sucursal?" NUNCA digas que la promo terminó.\n\n' +
      '⚠️ REGLAS CRÍTICAS AL HABLAR DE PRECIOS EN ESTA PROMO (no las rompas):\n' +
      '• ⛔ REGLA PRINCIPAL (por encima de todo lo demás sobre precios): los lentes de la promo se arman como un PAQUETE que se cotiza en la ÓPTICA. NO desgloses qué va "incluido sin costo extra" ni qué "sube el precio" por separado — no todo va incluido y ese desglose confunde. El precio depende del armazón, el material y los tratamientos (antirreflejante, blue light, fotocromático, etc.) y el tipo de graduación que elija el cliente; en sucursal le dan la cotización exacta. NUNCA sueltes frases tipo "el antirreflejante ya va incluido sin costo extra" ni "el blue light sube el precio" como afirmaciones sueltas.\n' +
      ...
      '• Los tratamientos (antirreflejante, blue light/luz azul, transitions/fotocromático, polarizado) son parte del PAQUETE que se cotiza en sucursal — ⛔ NO los clasifiques como "incluido gratis" vs "extra que sube el precio". Di que se cotizan JUNTO con el armazón y el material en la óptica según lo que elija el cliente.\n' +
      ...
      '• Si preguntan "¿qué está incluido?", "¿qué trae la promo?" o "¿ya incluye el blue light / antirreflejante?": ⛔ NO enlistes qué va incluido gratis vs qué es extra. Responde que los lentes se arman como un PAQUETE en la óptica: el precio depende del armazón, el material y los tratamientos (antirreflejante, blue light, fotocromático, etc.) y el tipo de graduación que necesite, y en sucursal le dan la cotización exacta según su vista. Con el 2x1 se lleva el doble pagando 1. El 3er lente solar es un par aparte (gratis en compras de $3,000+, o $499 si es menor). (El número que vea en un armazón es solo el marco, no el paquete completo.)\n' +
      '• Si el cliente pide "quitar el antirreflejante para pagar menos" o pregunta por lentes sin AR: NO entres en el desglose — recuérdale que los lentes se arman como paquete y la cotización se hace en sucursal según lo que elija.\n' +
      '• 💛🧾 SI UN CLIENTE RECLAMA que le cobraron el antirreflejante que "venía incluido" (o muestra su ticket con un renglón tipo "Anti-Blue AR $X", "Foto AR $X", "AR $X", "Hi Index ... AR $X"): ESE renglón NO es un cobro aparte del antirreflejante — es el PRECIO DE SUS MICAS GRADUADAS, que en el nombre ya traen el antirreflejante incluido (el AR va DENTRO del precio de la mica; el precio depende de la graduación + material + tratamiento que ya trae la mica). Está BIEN COBRADO. Aclaralo con CALIDEZ y SIN ponerte a la defensiva (que NUNCA sienta que se le engañó): "Ese renglón es el precio de tus micas graduadas, que ya vienen con el antirreflejante incluido — no es un cobro extra del antirreflejante, va dentro del precio de la mica. Está todo correcto 😊". NO ofrezcas devolver ni ajustar ese cargo (está bien cobrado), pero mantén el tono amable y tranquilízalo.\n' +
      '• ⛔ NUNCA distingas un "antirreflejante básico" (supuestamente incluido/gratis) de un "Anti-Blue" (supuestamente extra): NO existe un "AR básico" que se regale. TODAS las micas de la promoción YA incluyen antirreflejante; su precio ya lo trae. "Antirreflejante incluido" significa (a) que las micas de la promo son antirreflejantes y (b) que hasta el par de REGALO del 2x1 trae antirreflejante sin costo extra — NO que las micas se regalen aparte del armazón.\n' +
      '• ⛔ Si el cliente quiere PAGAR SOLO EL ARMAZÓN (ej. $1,200) y llevarse la graduación gratis: aclara con calidez que eso NO es la promo. El armazón es solo el marco; las micas graduadas (con su antirreflejante) tienen su propio precio, por eso el total no es solo el del armazón. La promo es 2x1 en lentes COMPLETOS (armazón + micas graduadas antirreflejantes), no "armazón con micas gratis". Si la vendedora no lo explicó bien, discúlpate por eso, pero el cobro es correcto.\n' +
      '• ⛔ CONFUSIÓN MÁS COMÚN — el cliente cree que PAGA LOS DOS pares (ej. "¿serían dos de $1,200?", "entonces pago dos armazones", "dos de 1200 más graduación", "¿los dos me cuestan el doble?"): DESHAZLA SIEMPRE con DOS aclaraciones. (1) El 2x1 = pagas UN SOLO par completo y el SEGUNDO par va INCLUIDO (NO lo pagas). (2) ⛔ MUY IMPORTANTE: el número que el cliente vio (ej. $1,200) es el precio del ARMAZÓN, NO de los lentes completos — NUNCA digas que ese número "ya incluye todo". El precio de los lentes completos se arma con ARMAZÓN + MATERIAL de la mica + TIPO DE GRADUACIÓN que necesite (el antirreflejante va incluido, sin cobrarse como línea aparte, PERO el material CR-39/policarbonato/alto índice y la graduación sencilla/bifocal/progresivo que su vista requiera SÍ definen el precio, así que el total es MÁS que solo el armazón). Explícalo así: "Con el 2x1 pagas UN par completo y el segundo va incluido, no pagas los dos 👓. Ojo: el precio que viste (ej. $1,200) es del armazón; el total de tus lentes es ese armazón + el material y el tipo de graduación que necesites (el antirreflejante ya va incluido, sin cobrarse aparte). Por eso la cotización exacta te la dan en sucursal según tu graduación." ⛔ NUNCA confirmes el número del cliente como precio final ni digas que "ya incluye todo".\n' +
  ...
  // Fallback (fuera de abril 2026 o antes del deploy). ⚠️ descEstudiante va TAMBIÉN aquí:
  // el gate de arriba es abril-julio, así que en AGOSTO la campaña de estudiantes solo llega por este return.
...
↔️ CERCANÍA ENTRE SUCURSALES (para cuando una está cerrada —domingos en Vittoria— o el cliente ya está parado en una y necesita otra): el orden geográfico real de las 4 es AMÉRICAS — VITTORIA — MAGNOLIA — PINOCELLI. Vecinas: Américas↔Vittoria · Vittoria↔MAGNOLIA · Magnolia↔Pinocelli. ➡️ La sucursal MÁS CERCANA a VITTORIA es MAGNOLIA (esa es la que ofreces si Vittoria está cerrada). ⛔ AMÉRICAS y PINOCELLI son las DOS MÁS ALEJADAS ENTRE SÍ: JAMÁS mandes a alguien de una a la otra como "la más cercana". ⛔ Pinocelli NO es vecina de Vittoria — está del otro extremo. Siempre da la DIRECCIÓN completa de la que ofrezcas.
...
2. SERVICIO A DOMICILIO: NO lo manejamos, y la razón que das es SIEMPRE técnica (no es lo recomendable), NUNCA temporal ni moral.
...
3. CURRÍCULUM / VACANTES: el correo para mandar CV es opticas@caryera.mx.
   ✅ VACANTE ABIERTA HOY (dato confirmado por la dirección — se actualiza cuando cambie): la ÚNICA vacante abierta es para OPTOMETRISTAS CERTIFICADOS. Si preguntan si hay vacantes o qué puestos hay, esa es la respuesta.
   ✅ SOLO si la persona ES optometrista certificado (o dice serlo): invítala a mandar su CV a opticas@caryera.mx indicando el puesto.
   ⛔ Si NO es optometrista —o pregunta por un familiar, amigo o conocido que no lo es, o quiere "aprender el oficio", o viene de otra carrera— NO le pidas el CV, NO le digas que lo mande "por si acaso" ni "de todas formas", y NO le prometas que se guarda para después. Responde corto y amable: por ahora la única vacante abierta es la de optometrista certificado y no hay otras plazas; que esté pendiente de nuestras redes por si se abre algo más. Amable, pero sin abrir la puerta.
   ⛔ NUNCA digas que el CV "se guarda", "queda en consideración", "lo tendremos en cuenta" ni nada que suene a bolsa de trabajo: no existe tal archivo y crea una expectativa falsa.
   ⛔ NUNCA inventes, enumeres ni sugieras OTROS puestos abiertos (nada de "ventas, laboratorio, caja" ni listas parecidas). La única vacante confirmada es la de optometrista certificado; de lo demás, NO tienes información.
   ⛔ NUNCA prometas entrevista, fecha, sueldo ni que los van a contactar en cierto plazo.
4. HORARIO Y ESPERAR AL CLIENTE: la regla aplica SOLO cuando el tema es la HORA DE CIERRE. Si el cliente pregunta si alcanza a llegar, va en camino tarde, o falta poco para cerrar → ⛔ NUNCA le asegures que "sí alcanza", que "lo esperan", que "te esperamos aunque llegues tarde", ni lo apures a llegar ("date prisa", "apúrate", "apurarte", "córrele"); tú NO controlas al personal de la sucursal. Di: "El horario es hasta las 7pm (o 5pm domingos). Te recomiendo llegar con tiempo suficiente para que te atiendan bien." Si llega y está cerrado, es peor que haberle dicho que viniera otro día.
   ✅ Fuera de ese caso, "¡Te esperamos!" como DESPEDIDA amable está permitido y suena natural (ej. "¡Perfecto, ahí te esperamos! 👓"). Lo prohibido es prometer que el personal lo espera FUERA del horario, no la cortesía.
...
// "Molestias en los ojos / en la vista" = SÍNTOMA clínico (motivo de examen), NO una queja de servicio.
// Ej (caso Mary): "he traído molestias en mis ojos, veo borroso" → es un prospecto que quiere examen.
// Proximidad: "molest" a pocas palabras de ojo/vista/leer/ver = síntoma ocular (en cualquier orden).
// NO se incluye "lentes" a propósito (para no tapar quejas reales tipo "molesto porque mis lentes salieron mal").
var SYMPTOM_PATTERNS = [
  /molest\w*(\s+\w+){0,3}\s+(ojo|ojos|vista|parpad|leer|ver\b)/i,   // "molestias en mis ojos", "molestan mucho los ojos al leer"
  /(ojo|ojos|vista|parpad)(\s+\w+){0,3}\s+(me\s+)?(molest|arde|duel|lloran|resec)/i, // "los ojos me molestan"
  /molest\w*\s+(visual|al\s+ver|al\s+leer|para\s+ver|para\s+leer|en\s+la\s+vista)/i,
  /(veo|ver)\s+borroso|vista\s+borrosa|visi[oó]n\s+borrosa/i // síntoma de vista
];
...
function isComplaintMessage(text) {
  ...
  if (onlyMolest) {
    ...
    var isSymptom = SYMPTOM_PATTERNS.some(function(rx) { return rx.test(text); });
    if (isSymptom) return false; // "molestias en los ojos" = motivo de examen, no queja de servicio
  }
  ...
  if (shouldLookupOrder) {
    ...
    if (orders && orders.length > 0) {
      ...
      orderContext = '\n\nBÚSQUEDA DE PEDIDO: No se encontraron pedidos activos para este número de teléfono ni con la información proporcionada.\n' +
        ...
        '5b. A quien pregunta por su pedido NO le des direcciones ni referencias de ubicación por iniciativa propia — ya es cliente, ya sabe dónde queda. 📞 El teléfono de su sucursal SÍ se lo puedes dar si lo pide.\n' +
