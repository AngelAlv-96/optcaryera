...
function getActivePromos() {
  ...
  if (year === 2026 && (month === 4 || month === 5 || month === 6 || month === 7)) {
    return cuponMexico + cuponSolar3x1 + hotSaleCarEra + campanaFotoColor + 'PROMOCIÓN VIGENTE:\n' +
      ...
      '• 💛 SI UN CLIENTE RECLAMA que le cobraron el antirreflejante que "venía incluido": trátalo con CALIDEZ y SIN ponerte a la defensiva (que NUNCA sienta que se le engañó). Reconoce que el AR va incluido y no se cobra aparte, ofrécete a revisar su ticket/folio, y dile que si hubo algún cargo que no debía ir se le ajusta. NO justifiques el cobro ni le expliques de más; enfócate en resolverlo y en que quede tranquilo.\n' +
